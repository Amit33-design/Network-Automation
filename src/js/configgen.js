...
system {
    ...
    login {
        announcement "Authorized access only. All activity is monitored.";
        retry-options { tries-before-disconnect 3; backoff-threshold 1; backoff-factor 5; lockout-period 5; }
        user admin {
            class super-user;
    ...
    services {
        ssh { root-login deny; protocol-version v2; max-sessions-per-connection 1; connection-limit 10; rate-limit 5; }
        netconf { ssh; }
        xnm-clear-text { no; }
    }
    syslog {
        ...
        file security { authorization any; interactive-commands any; }
...
banner motd ^
****************************************************************************
*  ${name} — Authorized access only. All activity is monitored and logged. *
*  Unauthorized access is prohibited and will be prosecuted to the full    *
*  extent of the law. Disconnect IMMEDIATELY if not an authorized user.    *
****************************************************************************
^
!
