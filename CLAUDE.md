...
| AM3 | **Routing and fabric facts** — extend `FactName` with bgp / isis / ospf / loopback / vxlan-evpn / jumbo-mtu / bfd / gpu-qos and migrate the validator's V-01/V-03/V-08/V-12/V-13/V-14 detectors (`RE_BGP`, `RE_ISIS`, `RE_OSPF`, `RE_LOOPBACK_IFACE`, `RE_ROUTING_DEVICE`) — the same one-regex-knows-every-vendor pattern, and the site of M3/M6/M7/Z6 | [ ] | |
